...
#create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { ps2_clk }];#set
...
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { red[1] }]; #IO_L17N_T2_34 Sch=ja_n[1]
...
## Pmod Header JB
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { green[0] }]; #IO_L8P_T1_34 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { green[1] }]; #IO_L8N_T1_34 Sch=jb_n[1]
...
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { ps2_data }]; #IO_L19P_T3_34 Sch=ck_io[26]
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { ps2_clk }]; #IO_L2N_T0_34 Sch=ck_io[27]
